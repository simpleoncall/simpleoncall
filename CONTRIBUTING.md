Contributing to SimpleOnCall
============================

SimpleOnCall is proudly open source and welcomes contributions from anyone. This
document explains how people can contribute to the project.

All bugs, feature requests and pull requests are triaged, assigned and can be
...
1. [Fork](https://help.github.com/articles/fork-a-repo) the project, clone your
   ...
   git clone https://github.com/<your-username>/simpleoncall.git
   # Navigate to the newly cloned directory
   cd simpleoncall
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/simpleoncall/simpleoncall.git
   ```
